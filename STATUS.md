...
1. 重新部署网页，让新的 meta 信息、分享图和站点文件上线
2. 用微信、Discord、X 或 Telegram 实测链接展开效果
3. 直接用浏览器打开 `http://127.0.0.1:8000/` 做一轮真实点击联调
4. 根据联调结果修正前端异常态、空态和按钮反馈
5. 视需要补一张 PNG 版社交分享图，再决定是否升级成组件化前端工程
